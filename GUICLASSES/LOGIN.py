...
class LoginWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        bg_image = Image.open("C:/Users/sgura/PycharmProjects/NewHacks\image_resources/bg2.jpeg")
    ...
    # Create Entry widgets (text boxes)
        self.entry1 = ctk.CTkEntry(self, width=180, bg_color="#1c1a1d")
        self.entry2 = ctk.CTkEntry(self, width=180, show="*", bg_color="#1c1a1d")
    ...
    def check_user(self, username, password) -> tuple:
        with open("C:/Users/sgura/PycharmProjects/NewHacks/Users/Users.csv", 'r') as file:
    ...
    def sign_up(self):
        ...
        self.destroy()
        signupwindow = SIGNUP.SignupWindow()
    ...
    def login(self):
        ...
        if result == "Login Successful":
            ...
            if filename:
                ...
                filename = ""
            self.destroy()
            main_window = MAIN.open_tk(filename)
